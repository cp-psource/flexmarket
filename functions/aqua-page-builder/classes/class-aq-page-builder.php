...
if(!class_exists('AQ_Page_Builder')) {
	class AQ_Page_Builder {
		...
		function view_enqueue() {
			...
			// front-end css (custom)
			wp_register_style( 'aqpb-view-custom-css', $this->url.'assets/css/aqpb-view-custom.css', array(), time(), 'all');
			wp_enqueue_style('aqpb-view-custom-css');
